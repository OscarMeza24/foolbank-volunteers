    ...
    <body class="bg-gray-100">
        <div class="min-h-screen flex items-center justify-center">
            <div class="max-w-4xl w-full space-y-8 p-8 bg-white rounded-lg shadow-md">
                ...
                @auth
                    <div class="text-center">
                        <a href="{{ route('events.index') }}" class="inline-block bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                            Ir a Eventos
                        </a>
                        <a href="{{ route('volunteers.index') }}" class="inline-block bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded ml-4">
                            Ir a Voluntarios
                        </a>
                    </div>
                @else
